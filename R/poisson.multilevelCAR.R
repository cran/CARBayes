poisson.multilevelCAR <- function(formula, data=NULL,  W, ind.area, burnin, n.sample, thin=1, prior.mean.beta=NULL, prior.var.beta=NULL, prior.tau2=NULL, rho=NULL,  MALA=TRUE, verbose=TRUE)
{
##############################################
