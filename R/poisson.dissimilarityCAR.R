...
function(formula, data=NULL, rho=0.99, W, Z, burnin=0, n.sample=1000, thin=1, blocksize.beta=5, prior.mean.beta=NULL, prior.var.beta=NULL, prior.tau2=NULL, verbose=TRUE)
{
...
#Q <- rho * (WW - diag(apply(WW,1,sum))) + (1-rho) * diag(rep(1,n))     
#det.Q <- sum(log(diag(chol.spam(Q))))     
