gaussian.bymCAR <-
function(formula, data=NULL,  W, burnin, n.sample, thin=1, prior.mean.beta=NULL, prior.var.beta=NULL, prior.nu2=NULL, prior.tau2=NULL, prior.sigma2=NULL, verbose=TRUE)
{
...
fitted.median <- X.standardised %*% median.beta + median.re + offset
...
samples <- list(beta=samples.beta.orig, re=mcmc(samples.re),  tau2=mcmc(samples.tau2), nu2=mcmc(samples.nu2), sigma2=mcmc(samples.sigma2), fitted=mcmc(samples.fitted))
