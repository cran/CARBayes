...
trials.mat <- matrix(trials, nrow=K, ncol=J, byrow=TRUE)
...
#### Create the MCMC samples     
    ...
    temp1 <- binomialmcarupdate(W.triplet, W.begfin, K, J, phi.mat, Y.mat.miss, failures.mat.miss, trials.mat,  phi.offset, den.offset, Sigma.inv, rho,  proposal.sd.phi, which.miss.mat)      
    if(rho<1)
        {
