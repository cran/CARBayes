poisson.lerouxCAR <- function(formula, beta=NULL, phi=NULL, tau2=NULL, rho=NULL, W, burnin=0, n.sample=1000, thin=1, blocksize.beta=5, blocksize.phi=10, prior.mean.beta=NULL, prior.var.beta=NULL, prior.max.tau2=NULL)
{
##############################################
...
###########################
     ...
     b <- rnorm(n)
          ...
          proposal.phi <- phi[phi.beg[r]:phi.fin[r]] + (sqrt(proposal.sd.phi) * t(chol(block.var))) %*% b[phi.beg[r]:phi.fin[r]]
