...
###########################
    ...
    proposal.beta <- beta    
        ...
        fitted.proposal <- exp(as.numeric(X.standardised %*% proposal.beta) + phi + theta + offset)
        fitted.current <- exp(as.numeric(X.standardised %*% beta) + phi + theta + offset)
    ...
    proposal.theta <- theta    
        ...
        fitted.proposal <- exp(offset.temp[beg[r]:fin[r]] + proposal.theta[beg[r]:fin[r]])
        fitted.current <- exp(offset.temp[beg[r]:fin[r]] + theta[beg[r]:fin[r]])
