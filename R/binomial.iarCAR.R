binomial.iarCAR <-
function(formula, beta=NULL, phi=NULL, tau2=NULL, trials, W, burnin=0, n.sample=1000, thin=1, blocksize.beta=5, blocksize.phi=10, prior.mean.beta=NULL, prior.var.beta=NULL, prior.max.tau2=NULL)
{
##############################################
...
cat("\n\n")
cat("Acceptance rate for the random effects is ", round(100 * accept.phi,1), "%","\n\n", sep="")
cat("DIC = ", DIC, "     ", "p.d = ", p.d, "\n")
